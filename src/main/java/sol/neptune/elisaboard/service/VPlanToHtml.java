...
public class VPlanToHtml {
     ...
     */
    public static VPlanToHtml create(Workbook wb, Appendable output) {
        return new VPlanToHtml(wb, output);
    }
     ...
     * @return An object for converting the workbook to HTML.
     */
    public static VPlanToHtml create(String path, Appendable output)
            throws IOException {
     ...
     * @return An object for converting the workbook to HTML.
     */
    public static VPlanToHtml create(InputStream in, Appendable output)
            throws IOException {
        try {
    ...
    private VPlanToHtml(Workbook wb, Appendable output) {
        if (wb == null) {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("usage: VPlanToHtml inputWorkbook outputHtmlFile");
            return;
        }

        VPlanToHtml toHtml = create(args[0], new PrintWriter(new FileWriter(args[1])));
